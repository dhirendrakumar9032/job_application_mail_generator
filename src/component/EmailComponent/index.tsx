...
const EmailComponent: React.FC = () => {
    ...
    const emailContent: string = `Hi ${name},\n\nGreat to connect with you!\n\nI’m a Frontend Developer with 3+ years experience in building scalable projects, and I’m currently exploring a new opportunity. I noticed ${company} is hiring for a ${position} position. \n\nWould you be open to referring me? It would be a great help!\n\nJob Post: ${url} \n\nJob Id: ${jobId}`;
